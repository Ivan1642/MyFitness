...
<div class="text-center py-20 bg-white rounded shadow">
    ...
    <h1 class="text-5xl font-bold mb-4 text-[#003942]">
        MyFitness
    </h1>

    <p class="text-[#003942] text-lg mb-8 max-w-xl mx-auto opacity-80">
        Registra tus entrenamientos, supera tus marcas personales y sigue tu progreso como nunca antes.
    </p>

    <div class="space-x-4">
        <a href="/register" class="bg-[#003942] text-white px-6 py-3 rounded">
            Empieza gratis
        </a>

        <a href="/login" class="border border-[#003942] text-[#003942] px-6 py-3 rounded">
            Iniciar sesión
        </a>
    </div>
...
<div class="grid md:grid-cols-3 gap-6 mt-12">
    ...
    <div class="bg-white p-6 rounded shadow text-center">
        <h2 class="font-bold text-xl mb-2 text-[#003942]">📊 Progreso real</h2>
    ...
    <div class="bg-white p-6 rounded shadow text-center">
        <h2 class="font-bold text-xl mb-2 text-[#003942]">🏋️ Entrenamientos</h2>
        <p class="text-[#003942] opacity-70">
    ...
    <div class="bg-white p-6 rounded shadow text-center">
        <h2 class="font-bold text-xl mb-2 text-[#003942]">👥 Comunidad</h2>
        <p class="text-[#003942] opacity-70">
