...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-2xl font-bold">Nueva rutina</h1>
    </div>
    ...
    <form method="POST" action="{{ route('routines.store') }}" id="routine-form">
        @csrf
        ...
        <div class="bg-white rounded-2xl shadow p-6 space-y-4 mb-6">
            ...
            <div>
                ...
                <textarea name="description" rows="2"
                    ...
                    placeholder="Ej: Rutina de fuerza para tren superior...">{{ old('description') }}</textarea>
            </div>
        </div>
...
@push('scripts')
    @vite('resources/js/pages/routine-create.js')
@endpush